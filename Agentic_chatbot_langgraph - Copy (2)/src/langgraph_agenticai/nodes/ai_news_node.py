...
class AINewsNode:
    ...
    def fetch_news(self, state: dict) -> dict: 
        frequency = state['message'][0].content.lower()  # Now safe to call .lower()
        ...
        response = self.tavily.search(
            ...
            #include_domains = ["techcrunch.com", "thenextweb.com", "wired.com", "theverge.com"] #uncomment and add domains if needed
        )
    ...
    def summarize_news(self, state : dict) -> dict:
        """
        Summarize fetched news articles using LLM.
        args:
        state (dict): the state dictionary containing the news_data
        returns:
        dict : updated state with summarized_news key containing summarized news
        """
